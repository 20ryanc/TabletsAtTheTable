...
public class OrderTmp {
    ...
    public OrderTmp(Long id, Integer group_size, Integer female, Integer male, Integer babies, Integer children, Integer young_adults, Integer middle_age_adults, Integer old_adults, List<Item> order_items) {
        this.id = id;
